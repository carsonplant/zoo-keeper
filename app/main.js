...
let carlos = new Camel("Carlos", "Sandy", 2, "F", "5ft", 942, "Adult", "Saudi Arabia");
let donny = new Deer("Donny", "Mule", "Brown", "F", 0, "4ft", 127, "Youth", "Colorado");
let earnie = new Elephant("Earnie", "African Bush", "Grey", 2, true, "M", "11.5ft", 10753, "Mature", "Ethiopia");
let frankie = new Flamingo("Frankie", "Pink", "F", "4ft", 6, "Adult", "Chile");
